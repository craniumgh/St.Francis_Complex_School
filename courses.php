            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-4 col-md-4">
                        <div class="logo">
                            <a href="index-2.php">
                                <img src="images/S (26).jpg" alt="SFOSA" class="rounded-circle" height="100" width="100">
                            </a>
                        </div>
                    </div>
                    <div class="col-lg-8 col-md-8">
                        <div class="support-button float-right d-none d-md-block">
                            <div class="support float-left">
                                ...
                                <div class="cont">
                                    <p>Need Help? call us Affordable</p>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6">
                            <div class="singel-course mt-30">
                                <div class="thum">
                                    <div class="image">
                                        <img src="images/S (17).jpg" alt="Course">
                                    </div>
                                    <div class="price">
                                ...
                                <div class="cont">
                                    ...
                                    <a href="courses-singel.php">
                                        <h4>Pre-School Departments</h4>
                                    </a>
                                    <div class="course-teacher">
                                        <div class="thum">
                                            <a href="#"><img src="images/S (17).jpg" alt="teacher"></a>
                                        </div>
                                        <div class="name">
                                            <a href="#">
                                                <h6>Big Madam</h6>
                ...
                <div class="row">
                    <div class="col-lg-3 col-md-6">
                        <div class="footer-about mt-40">
                            <div class="logo">
                                <a href="#"><img src="images/S (26).jpg" alt="Logo" width="50" height="50"></a>
                            </div>
                            <p>Gravida nibh vel velit auctor aliquetn quibibendum auci
