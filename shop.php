                    ...
                    <div class="shop-top-search">
                            ...
                            <ul class="nav" id="myTab" role="tablist">
                                <li class="nav-item">
                                    <a class="active" id="shop-grid-tab" data-toggle="tab" href="#shop-grid" role="tab"
                                        aria-controls="shop-grid" aria-selected="true"><i
                                            class="fa fa-th-large"></i></a>
                                </li>
                                <li class="nav-item">
                                    <a id="shop-list-tab" data-toggle="tab" href="#shop-list" role="tab"
                                        aria-controls="shop-list" aria-selected="false"><i
                        ...
                        <div class="shop-select">
                            <select>
                                ...
                                <option value="3">Sort by Volume</option>
                                <option value="4">Sort by Authors</option>
                                <option value="5">Sort by Genre</option>
                            </select>
                        </div> <!-- shop select -->
                    </div> <!-- shop top search -->
                </div>
                            ...
                            <div class="singel-publication mt-30">
                                ...
                                <div class="cont">
                                    ...
                                    <div class="button text-right">
                                        <a href="#" class="main-btn">Borrow Now</a>
                                    </div>
                                </div>
